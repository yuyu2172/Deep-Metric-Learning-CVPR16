...
[image_ids, class_ids, superclass_ids, path_list] = ...
    textread('/home/leus/.chainer/dataset/pfnet/chainercv/online_products/Stanford_Online_Products/Ebay_train.txt', '%d %d %d %s',...
    'headerlines', 1);
...
[image_ids, class_ids, superclass_ids, path_list] = ...
    textread('/home/leus/.chainer/dataset/pfnet/chainercv/online_products/Stanford_Online_Products/Ebay_test.txt', '%d %d %d %s',...
    'headerlines', 1);
